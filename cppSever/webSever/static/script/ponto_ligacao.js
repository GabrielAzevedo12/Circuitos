    ...
    if(fgs.Existe_Class(e.target,"ponto_ligacao_ligar")) {
        ...
        if(e.target.vinculo.state === true) {
            ...
            if (Ligar_obj.arg1) {
                ...
                if (analisar_vinculoId(Ligar_obj.arg1,e.target)) {
                    ...
                    if ( fgs.Existe_Class(ponto_ligacao,"off") ) {
                        ...
                        resistirCorrente_ponto_ligaçao(ponto_ligacao);
        
                    }
        
                } else {
                    Ligar_obj.Ligar_2(ponto_ligacao);
                }
...
let ponto_ligaçao = () => {
    ...
    let ponto_ligaçao = gerarElementoHtml(
        ...
        ponto_ligaçao.element.addEventListener('click', (e) => {
