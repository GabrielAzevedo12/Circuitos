let Ligar_xy_2 = (e1,e2) => {

    console.log("Ligar_xy_2 está sendo executada")
    ...
    if(fgs.Existe_Class(e1,"entrada") && fgs.Existe_Class(e2,"entrada")) {
        ...
        [constante_entrada] = [(posiçao_e1_parent.y - parent_child1.y)];
    };
    let 
    //vetor de e1
...
if (dx && dy && (dx !== 0)) {
    let
    Def_ligaçoes = (r1, r2, r3, r4, r5) => {
        e1.vinculo.state = true;
        e1.vinculo.id = e2;
        e1.vinculo.ligaçoes = [r1, r2, r3, r4, r5];

        e2.vinculo.state = true ;
        e2.vinculo.id = e1;    
        e2.vinculo.ligaçoes = [r1, r2, r3, r4, r5];
    },
    objEntrada = 
{ 
...
//-----------------------------------------------------------------------------------------------------
    ...
    Existe_Vinc_s1 = () => {
        ...
        let fios = e1.vinculo.ligaçoes, i = 0, a = [];
        ...
        //console.log(a);
        for(let r of a) {
            (r === undefined) ? console.log(r + " não está definido") : redefinir_dimensoes(r);
        }
        ...
        } else if (objEntrada.ponto_ligaçao[1]) { 
            objEntrada.açao_typeEntrada2(a[0],a[1],a[2]);
            Def_ligaçoes(a[0],a[1],a[2]);
        } 
